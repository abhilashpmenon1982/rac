sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("abc/sap/app", ".html");
		...
		return Opa5.extend("abc.sap.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["abc/sap/localService/mockserver"], function (mockserver) {
